...
const translations = {
  en: {
    ...
    work_eyebrow:      'Practice & Craft',
    work_title:        'Work <em>&amp; Experience</em>',
    work_subtitle:     'What I do when I am not chasing sentences.',
    work_period:       '3 Years — Present',
    work_role:         'Adult Diploma Instructor — Systems Operations',
    work_place:        'Kharazmi Educational Institute',
    work_desc:         'Teaching adult learners the fundamentals of systems operations, with a practical focus on website design and Telegram bot development in Python.',
    work_skills_title: 'Technical Practice',
    work_tag_web:      'Web Design',
    work_tag_bot:      'Telegram Bots',
    work_tag_html:     'HTML &amp; CSS',
    work_tag_js:       'JavaScript',
    work_tag_python:   'Python',
    work_tag_teaching: 'Teaching',
    fav_game_label:    'Game',
    fav_game_value:    'The Witcher 3',
    fav_series_label:  'Series',
    fav_series_value:  'The Sopranos',
    fav_film_label:    'Film',
    fav_film_value:    'Forrest Gump',
  ...
  fa: {
    ...
    work_eyebrow:      'تجربه و تخصص',
    work_title:        'سوابق <em>کاری</em>',
    work_subtitle:     'کاری که می‌کنم وقتی دنبال جمله نیستم.',
    work_period:       '۳ سال — تاکنون',
    work_role:         'مربی دوره دیپلم بزرگسالان — امور سیستمی',
    work_place:        'آموزشگاه خوارزمی',
    work_desc:         'آموزش مبانی امور سیستمی به هنرجویان بزرگسال، با تمرکز عملی بر طراحی وب‌سایت و توسعه ربات‌های تلگرامی با پایتون.',
    work_skills_title: 'مهارت‌های فنی',
    work_tag_web:      'طراحی وب‌سایت',
    work_tag_bot:      'ربات تلگرامی',
    work_tag_html:     'HTML و CSS',
    work_tag_js:       'جاوااسکریپت',
    work_tag_python:   'پایتون',
    work_tag_teaching: 'تدریس',
    fav_game_label:    'بازی',
    fav_game_value:    'ویچر ۳',
    fav_series_label:  'سریال',
    fav_series_value:  'سوپرانو',
    fav_film_label:    'فیلم',
    fav_film_value:    'فارست گامپ',
